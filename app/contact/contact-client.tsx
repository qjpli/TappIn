      ...
      <main className="container mx-auto p-4 md:p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 mt-12">
          ...
          <section className="bg-white dark:bg-transparent p-8 rounded-lg">
            ...
            <button className="bg-primary dark:bg-gray-800 text-white px-6 py-3 rounded-md font-semibold hover:bg-gray-900 transition duration-300 shadow-md">
              Customer Support
            </button>
          ...
          <section className="bg-white dark:bg-neutral-900 p-8 rounded-lg shadow-md dark:text-white">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    id="first-name"
                    className="w-full px-4 py-3 border dark:bg-neutral-800 dark:border-zinc-800 border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-100"
              ...
              <div>
                ...
                <div className="flex">
                  <span className="inline-flex items-center dark:bg-neutral-800 dark:border-zinc-800 px-4 py-3 border border-r-0 border-gray-300 rounded-l-md bg-gray-100 text-gray-600">
                    +63
                  ...
                  <input
                    type="tel"
                    id="phone-number"
                    className="flex-1 px-4 py-3 border dark:bg-neutral-800 dark:border-zinc-800 border-gray-300 rounded-r-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-100"
              ...
              <div>
                ...
                <textarea
                  id="message"
                  rows={4}
                  className="w-full px-4 py-3 border dark:bg-neutral-800 dark:border-zinc-800 border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-100 resize-none"
              ...
              <button
                type="submit"
                className="w-full bg-primary dark:bg-gray-800 text-white px-6 py-3 rounded-md font-semibold hover:bg-gray-900 transition duration-300 shadow-lg"
              >
                Submit
              </button>
